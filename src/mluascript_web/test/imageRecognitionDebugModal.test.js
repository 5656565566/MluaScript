...
test('image recognition debug keeps results visible and supports numeric and pointer ROI selection', () => {
  ...
  assert.match(source, /<n-slider :value="draft\.threshold" :min="0" :max="1" :step="0\.01"/)
  assert.match(source, /阈值 \{\{ thresholdLabel \}\}/)
  assert.doesNotMatch(source, /<n-input-number v-if="draft\.kind === 'template'"/)
